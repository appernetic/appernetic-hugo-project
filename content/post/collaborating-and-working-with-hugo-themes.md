...
From now on it is very easy to start blogging. Select the post directory in the tree view, it is where blog post lives. Create a new file name it with a headline, it will be slugified automatically 
