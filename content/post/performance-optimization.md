...
Our uptime monitoring with Pingdom also shows that the we are on the [right track now][4]. For the front page we now have performance grade 92/100. Google PageSpeed Insights shows 67/100 for mobile devices and 87/100 for  
